    ...
    <div class="mainContent">
        ...
        <nav class="navbar navbar-expand-lg ">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php" style="color: white;font-size:2rem;">Basic Banking Web</a>
        ...
        <div class="Container">
            <div class="row" style="width: 100%;">
                <div class="col-md-5">
                    <center>
                        <p>Give Money & Get Money <br> Simple way to transfer</p>
                    </center>

                </div>
                <div class="col-md-7">
                    <center>
                        <img src="assets/images/Bank.png" alt="" class="vert-move">
                    </center>
                </div>
            </div>
        </div>
